export const initialData = {
  "settings": {
    "churchName": {
      "zh": "大山脚浸信教会",
      "en": "Bukit Mertajam Baptist Church"
    },
  ...
  "timetable": [
    ...
    },
    {
      ...
      "location": {
        "zh": "智慧谷 (教会楼上)",
        "en": "Wisdom Valley (Church Upper floor)"
      },
      "language": {
        "zh": "华语",
        "en": "Chinese"
  ...
  "ministries": [
    {
      ...
      "image": "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRU7XuB-72CyprQCD8NFdgcrnY-zfOpbJeX-pxR3G8Iqg&s=10",
      "description": {
  ...
  "offerings": {
    ...
    "scripture": {
      "zh": "「你们要将当纳的十分之一全部送入仓库，使我家有粮。以此试试我，是否为你们敞开天上的窗户，倾福与你们，甚至无处可容。万军之耶和华说：“我必为你们斥责蝗虫，不容它毁坏你们的土产，你们田间的葡萄树在未熟之先也不掉果子。万军之耶和华说：“万国必称你们为有福的，因你们的地必成为喜乐之地。」—— 玛拉基书 3:10 - 12",
    ...
    "contactNote": {
      "zh": "如有任何关于奉献的疑问，请联系教会办公室或WhatsApp：+60 12-345 6789",
